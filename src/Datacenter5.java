...
public class Datacenter5 {
	...
	public static void main(String []args) {
		...
		try {
			...
			//initialize cloudsim here
			CloudSim.init(num_of_user, calendar, trace_flag);
			//create five datacenter
//			@SuppressWarnings("unused")
			...
			//create broker now to handle query from user side
			...
			//create vm list for each broker
			...
			Vm vm2 = new Vm((vmid+1), brokerId2, mips, pesNumber, ram, bw, size, vmm, new CloudletSchedulerTimeShared());
			
			//the third VM: this one belongs to user3
			Vm vm3 = new Vm((vmid+2), brokerId3, mips, pesNumber, ram, bw, size, vmm, new CloudletSchedulerTimeShared());
			...
			Cloudlet cloudlet3 = new Cloudlet((id+2), length, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel);
...
//	        Process pr = rt.exec(command);
			...
			Log.printLine("Datacenter5 simulation finished!");
		}
		catch(Exception e){
			e.printStackTrace();
			Log.printLine("simulation has been stoped due to some error");
		}
	}
